...
public class LoginState extends State {
    ...
    public LoginState() {
        ...
        lblUsername.setBounds(390, 350, 200, 30);
        lblPassword.setBounds(390, 450, 200, 30);
        lblLoginFail.setBounds(460, 500, 300, 30);
        lblSuccess.setBounds(480, 740, 300, 50);
        txtLogUsername.setBounds(480, 350, 200, 30);
        txtLogPass.setBounds(480, 450, 200, 30);
        btnLogin.setBounds(300, 550, 180, 50);
        btnRegister.setBounds(500, 550, 180, 50);
        btnCustomerView.setBounds(700, 550, 180, 50);
        btnExit.setBounds(500, 800, 180, 50);
...
//--------------------------------------------------------------------------------------------------------------------------
        ...
        lblName.setBounds(410, 400, 100, 30);
        lblAddress.setBounds(410, 450, 100, 30);
        lblRegUsername.setBounds(410, 500, 100, 30);
        lblPhone.setBounds(410, 550, 120, 30);
        lblRegPass.setBounds(410, 600, 100, 30);
        lblError.setBounds(480, 730, 300, 50);

        lblPassX1.setBounds(480, 640, 50, 30);
        lblPassCheck1.setBounds(480, 640, 50, 30);
        lblPassX2.setBounds(620, 640, 50, 30);
        lblPassCheck2.setBounds(620, 640, 50, 30);
        lblPassX3.setBounds(720, 640, 50, 30);
        lblPassCheck3.setBounds(720, 640, 50, 30);

        lblPassReq1.setBounds(430, 640, 500, 30); //Length
        lblPassReq2.setBounds(510, 640, 500, 30);//Special Character
        lblPassReq3.setBounds(650, 640, 500, 30);//Uppercase
        txtName.setBounds(545, 400, 200, 30);
        txtAddress.setBounds(545, 450, 200, 30);
        txtRegUsername.setBounds(545, 500, 200, 30);
        txtPhone.setBounds(545, 550, 200, 30);
        txtRegPass.setBounds(545, 600, 200, 30);

        btnBack.setBounds(20, 820, 130, 30);
        btnSubmit.setBounds(500, 690, 180, 50);
